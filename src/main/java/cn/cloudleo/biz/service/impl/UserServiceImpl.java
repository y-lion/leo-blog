...
import cn.cloudleo.biz.mapper.UserMapper;
import cn.cloudleo.biz.service.UserService;
import cn.cloudleo.common.utils.Md5Util;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, SysUser> implements UserService {
    ...
    public void add(SysUser sysUser) {
        ...
        sysUser.setAvatar("/img/avatar/default.png");
    ...
    public void updatePass(SysUser sysUser) {
        String encryptPassword = md5Util.encryptPassword(sysUser.getPassword());//加密
        userMapper.updateById(sysUser.setPassword(encryptPassword));
    }
